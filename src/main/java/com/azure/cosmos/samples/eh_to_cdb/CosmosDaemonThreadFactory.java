...
public class CosmosDaemonThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(Runnable r, String nameSuffix) {
        final String name = lenientFormat(NAME_TEMPLATE, this.namePrefix + nameSuffix, this.threadCount.incrementAndGet());
        Thread t = new Thread(r, name);
        t.setDaemon(true);
        return t;
    }
